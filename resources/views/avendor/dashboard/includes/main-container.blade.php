    ...
    <div class="content content-full">
      <div
        ...
        <div class="flex-sm-fill">
          <h1 class="h3 font-w700 mb-2">Vendor Dashboard</h1>
          <h2 class="h6 font-w500 text-muted mb-0">
            Welcome <a class="font-w600" href="javascript:void(0)">{{ Auth::guard('vendors')->user()->name }}</a>,
    ...
    <div class="row row-deck">
      <div class="col-sm-6 col-xl-3">
        ...
        <div class="block block-rounded d-flex flex-column">
          <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
            <dl class="mb-0">
              <dt class="font-size-h2 font-w700">{{ $deliveryOrders->count() }}</dt>
              <dd class="text-muted mb-0">{{ trans('main_trans.Delivery Orders') }}</dd>
            </dl>
          ...
          <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
            <a class="font-w500 d-flex align-items-center" href="{{ route('deliveryOrders.index') }}">
              <span>{{ trans('main_trans.View all orders') }}</span>
      ...
      <div class="col-sm-6 col-xl-3">
        ...
        <div class="block block-rounded d-flex flex-column">
          <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
            <dl class="mb-0">
              <dt class="font-size-h2 font-w700">{{ $serviceOrders->count() }}</dt>
              <dd class="text-muted mb-0">{{ trans('main_trans.Service Orders') }}</dd>
            </dl>
            <div class="item item-rounded bg-body">
          ...
          <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
            <a class="font-w500 d-flex align-items-center" href="{{ route('service.orders.index') }}">
              <span>{{ trans('main_trans.View all services Orders') }}</span>
              <i class="fa fa-arrow-alt-circle-right ml-1 opacity-25 font-size-base"></i>
            </a>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-xl-3">
        ...
        <div class="block block-rounded d-flex flex-column">
          <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
            <dl class="mb-0">
              <dt class="font-size-h2 font-w700">{{ $totalProfit . ' ' . $currencyCode }}</dt>
              <dd class="text-muted mb-0">{{ trans('main_trans.Profit') }}</dd>
            </dl>
            <div class="item item-rounded bg-body">
          ...
          <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
            <a class="font-w500 d-none align-items-center" href="javascript:void(0)">
              View Profits
              <i class="fa fa-arrow-alt-circle-right ml-1 opacity-25 font-size-base"></i>
            </a>
          </div>
          ...
          <div class="col-md-6 col-xl-12">
            <div class="block block-rounded d-flex flex-column">
              ...
              <div class="block-content p-1 text-center overflow-hidden">
                ...
                <span class="js-sparkline" data-type="line" data-points="[33,29,32,37,38,30,34,28,43,45,26,45,49,39]"
                  data-width="100%" data-height="70px" data-chart-range-min="20"
                  data-line-color="rgba(210, 108, 122, .4)" data-fill-color="rgba(210, 108, 122, .15)"
                  data-spot-color="transparent" data-min-spot-color="transparent" data-max-spot-color="transparent"
            ...
            <div class="block block-rounded d-flex flex-column">
              ...
              <div class="block-content p-1 text-center oveflow-hidden">
                ...
                <span class="js-sparkline" data-type="line"
                  data-points="[716,1185,750,1365,956,890,1200,968,1158,1025,920,1190,720,1352]" data-width="100%"
                  data-height="70px" data-chart-range-min="300" data-line-color="rgba(70,195,123, .4)"
          ...
          <div class="col-xl-12">
            <div class="block block-rounded d-flex flex-column">
              ...
              <div class="block-content p-1 text-center oveflow-hidden">
                ...
                <span class="js-sparkline" data-type="line" data-points="[25,15,36,14,29,19,36,41,28,26,29,33,23,41]"
                  data-width="100%" data-height="70px" data-chart-range-min="0" data-line-color="rgba(70,195,123, .4)"
                  data-fill-color="rgba(70,195,123, .15)" data-spot-color="transparent"
                  data-min-spot-color="transparent" data-max-spot-color="transparent"
                  data-highlight-spot-color="#46C37B" data-highlight-line-color="#46C37B"
                  data-tooltip-prefix="$"></span>
