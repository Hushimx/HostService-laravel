...
<main id="main-container">
  ...
  <x-hero>
    <x-slot name="title">
      {{ trans('main_trans.manage') }} <small class="font-size-base font-w400 text-muted">{{ trans('main_trans.stores') }}</small>
    </x-slot>
    <li class="breadcrumb-item" aria-current="page">
      <a class="link-fx" href="{{ route('vendor.dashboard') }}">{{ trans('main_trans.Dashboard_page') }}</a>
    </li>
    <li class="breadcrumb-item">{{ trans('main_trans.manage') }} {{ trans('main_trans.stores') }}</li>
  </x-hero>
